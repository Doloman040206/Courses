...
Цей проект є платформою онлайн курсів для студетів, який розробленою на ASP.NET Core MVC з використанням Entity Framework Core та MS SQL Server. Його основні можливості:
